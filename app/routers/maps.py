...
# Si sí tienes el CRUD:
# from app.crud.agenda_crud import listar_eventos
...
def ver_maps(
    ...
    # eventos = listar_eventos(db)  # si no lo tienes, comenta
    eventos = []  # temporal para que no truene
